...
export const initialState = loadState() || {
	tracks: [
		{ name: 'Drum 1', note: 36, channel: 10, type: 'drum', color: colors[3][0], muted: false },
		{ name: 'Drum 2', note: 37, channel: 10, type: 'drum', color: colors[3][1], muted: false },
		{ name: 'Drum 3', note: 38, channel: 10, type: 'drum', color: colors[3][2], muted: false },
		{ name: 'Drum 4', note: 39, channel: 10, type: 'drum', color: colors[3][3], muted: false },
		{ name: 'Drum 5', note: 40, channel: 10, type: 'drum', color: colors[3][4], muted: false },
		{ name: 'Drum 6', note: 41, channel: 10, type: 'drum', color: colors[3][5], muted: false },
